...
presencePreview: {
  ...
  adminHeaderTitle: { color: C.text, fontSize: 16, fontWeight: "700" },
  adminTabRow: {
    flexDirection: "row",
    borderBottomWidth: 1,
  ...
  adminTabActive: { borderBottomColor: C.accent },
  adminTabText: { color: C.muted, fontSize: 13, fontWeight: "600" },
  adminTabTextActive: { color: C.text },
